    ...
    <div class="container">
        <form action="join" method="POST" id="join-form">
            <fieldset>
                ...
                <div class="form-floating mb-3">
                    <input type="password" class="form-control" name="pwd" id="user-password" placeholder="비밀번호">
                    <label for="floatingPassword">비밀번호</label>
                </div>
                <div class="form-floating mb-3">
                    <input type="password" class="form-control" name="pwdchk" id="user-passwordchk" placeholder="비밀번호 확인">
                    <label for="floatingPassword">비밀번호 확인</label>
                    <small id="idHelp" class="form-text text-muted">비밀번호를 한 번 더 입력해주세요.</small>
                </div>
                <br>
                ...
                <div class="form-floating mb-3">
                    <input type="text" class="form-control" name="addr" id="user-addr" placeholder="주소">
                ...
                <br>
                <div class="form-group">
                    <button type="submit" class="btn btn-primary btn-nm">가입하기</button>
